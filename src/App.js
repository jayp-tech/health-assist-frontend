...
import EditInfo from "./containers/edit-info";
        ...
        <>
            <BrowserRouter>
                <Routes>
                    ...
                    />
                    <Route
                        path={PathConstants.PatientLogin}
                        element={<Login />}
                    />
                    <Route
                        path={PathConstants.PatientSignup}
                        element={<Signup />}
                    />
                    <Route
                        path={PathConstants.StatusPage}
                        element={<StatusPage />}
                    />
                    <Route
                    ...
                    />
                    <Route
                        path={PathConstants.DoctorLogin}
                    ...
                    />
                    <Route
                        path={PathConstants.CounselorLOP}
                        element={<CounselorLOP />}
                    />
                    <Route
                        path={PathConstants.DoctorLOP}
                        element={<DoctorLOP />}
                    />
                    <Route
                    ...
                    />
                    <Route
                        path={PathConstants.ManagerDataAnalytics}
                        element={<ManagerDataAnalytics />}
                    />
                    <Route
                        path={PathConstants.PatientEditProfile}
                        element={<EditInfo role={UserRole.PATIENT} />}
                    />
                    <Route
                        path={PathConstants.CounselorEditProfile}
                        element={<EditInfo role={UserRole.COUNSELOR} />}
                    />
                    <Route
                        path={PathConstants.DoctorEditProfile}
                        element={<EditInfo role={UserRole.DOCTOR} />}
                    />
                    <Route
                        path={PathConstants.ManagerLogin}
                        element={<AdminLogin />}
                    />
                    <Route
                        path={PathConstants.ManagePatient}
                        element={<ManagePatient />}
                    />
                    <Route
                        path={PathConstants.ManageDoctor}
                    ...
                    />
                    <Route
                        path={PathConstants.ManagerCreatePatient}
                        element={<ManagerCreateUser role={UserRole.PATIENT} />}
                    />
                    <Route
                        path={PathConstants.ManagerCreateCounselor}
                        element={
                            <ManagerCreateUser role={UserRole.COUNSELOR} />
                        }
                    />
                    <Route
                        path={PathConstants.ManagerCreateDoctor}
                        element={<ManagerCreateUser role={UserRole.DOCTOR} />}
                    />
                </Routes>
            </BrowserRouter>
            <MessageModal />
